...
def load_dataset():
    train_dataset = h5py.File('datasets/train_catvnoncat.h5', "r")      #训练集
    ...
    test_dataset = h5py.File('datasets/test_catvnoncat.h5', "r")        #测试集
    ...
    train_set_y_orig = train_set_y_orig.reshape((1, train_set_y_orig.shape[0]))     #将y变成行向量
